...
import 'package:biodata_app/biodata_form.dart';
...
class EditState extends State<Edit> {
  ...
  late TextEditingController nisController, namaController,
  tpController, tgController, agamaController, alamatController;
  ...
  void initState() {
    ...
    tpController = TextEditingController(text: widget.sw.tp);
    tgController = TextEditingController(text: widget.sw.tg);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      buttomNavigationBar: BottomAppBar (
